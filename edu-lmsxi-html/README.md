...
Este repo plantea unos ejercicios sencillos sobre HTML y su sintaxis

## Concreciones sobre especificaciones

### Despliega tu entorno necesario

Emplea el editor HTML de tu preferencia
...
Describe tu trabajo en `doc/Work.md`
...
- Conocer el lenguaje de marcas HTML y su sintaxis
